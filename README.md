...
- 🔐 **Шифрование токенов** - AES-256-GCM для защиты учетных данных (NEW в v0.4.0)
- 🖥️ **Информация о дисплеях** - разрешение, частота обновления, ориентация (NEW в v0.4.0)
- 🌐 **Внешний IP** - определение публичного IP-адреса (NEW в v0.3.0)
- 📦 **Установленное ПО** - полный список программ на системе (NEW в v0.3.0)
...
#### Вариант 1: Зашифрованные токены (🔐 Рекомендуется, NEW в v0.4.0)
...
#### Вариант 2: Незашифрованные токены (⚠️ Менее безопасно)
...
### Сборка для Windows (NEW в v0.4.0)
